...
const federated = {
    ...
    ios_client_id: "406870138631-gij1gqm9da7vm41skgm2kuqfj9d8egt8.apps.googleusercontent.com",
    android_client_id: "406870138631-sj6m04qmuso72pre9b1oso3t7cv0fsin.apps.googleusercontent.com"
}

export default withAuthenticator(connect(state=>({
    ...state.userForm
}))(TodayScreen), true, [], federated);
